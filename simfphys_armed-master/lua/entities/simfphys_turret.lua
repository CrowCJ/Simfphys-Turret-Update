...
ENT.FXToRadius = {
	...
	["simfphys_tankweapon_explosion_micro"] = 35,
	["simfphys_tankweapon_explosion_small"] = 125,
}
...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Float",1, "ShootDelay", { KeyName = "Shoot Delay", Edit = { type = "Float", order = 1,min = 0.05, max = 20, category = "Options"} } )
	self:NetworkVar( "Float",2, "Damage", { KeyName = "Damage", Edit = { type = "Float", order = 2,min = 0, max = 8000, category = "Options"} } )
	self:NetworkVar( "Float",4, "Force", { KeyName = "Force", Edit = { type = "Float", order = 3,min = 0, max = 15000, category = "Options"} } )
	self:NetworkVar( "Float",5, "Size", { KeyName = "Size", Edit = { type = "Float", order = 4,min = 0.5, max = 25, category = "Options"} } )
	self:NetworkVar( "Float",6, "DeflectAng", { KeyName = "DeflectAng", Edit = { type = "Float", order = 5, min = 0, max = 45, category = "Options"} } )
	self:NetworkVar( "Float",7, "BlastDamage", { KeyName = "Blast Damage", Edit = { type = "Float", order = 6, min = 0, max = 5000, category = "Options"} } )
